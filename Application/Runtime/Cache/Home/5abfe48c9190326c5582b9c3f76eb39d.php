...
-->
<link rel="stylesheet" href="<?php echo C('HOME_CSS_PATH');?>list.css" type="text/css">
<link rel="stylesheet" href="<?php echo C('HOME_CSS_PATH');?>common.css" type="text/css">

<script type="text/javascript" src="<?php echo C('HOME_JS_PATH');?>list.js"></script>
		...
		<div class="newgoods leftbar mt10">
			...
			<div class="leftbar_wrap">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>list_hot1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>list_hot2.jpg" alt="" /></a></dt>
					...
					<li class="last">
						<dl>
							<dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>list_hot3.jpg" alt="" /></a></dt>
...
<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
	<dl>
		<dt><a href="<?php echo U('detail',array('id'=>$v['id']));?>" target="_blank"><img src="<?php echo ($v["sm_logo"]); ?>" alt="" /></a></dt>
		<dd><a href="<?php echo U('detail',array('id'=>$v['id']));?>" target="_blank"><?php echo ($v["goods_name"]); ?></a></dt>
