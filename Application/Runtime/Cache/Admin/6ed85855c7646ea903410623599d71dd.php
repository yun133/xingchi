...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<img alt="" src="<?php echo C('ADMIN_IMAGE_PATH');?>avatar1_small.jpg" />
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(CONTROLLER_NAME=='Goods'){echo 'active';} ?>">					
					<a href="javascript:;">
					<i class="icon-cogs"></i> 
					...
					<ul class="sub-menu">
						<li class="<?php if(ACTION_NAME=='goods_add'){echo 'active';} ?>">
							<a href="<?php echo U('Goods/goods_add');?>">商品添加</a>
						</li>
						<li class="<?php if(ACTION_NAME=='goods_list'){echo 'active';} ?>">
							<a href="<?php echo U('Goods/goods_list');?>">商品列表</a>
						</li>
					</ul>
				</li>
				<li class="<?php if(CONTROLLER_NAME=='Category'){echo 'active';} ?>">					
					...
					<ul class="sub-menu">
						<li class="<?php if(ACTION_NAME=='cat_add'){echo 'active';} ?>">
							<a href="<?php echo U('Category/cat_add');?>">添加分类</a>
						</li>
						<li class="<?php if(ACTION_NAME=='cat_list'){echo 'active';} ?>">
							<a href="<?php echo U('Category/cat_list');?>">分类列表</a>
						</li>
					</ul>
				</li>
			</ul>
								...
								<form action="" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">								
									...
									<div class="control-group">
										...
										<div class="controls">											
											...
											<?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($info['parent_id'] == $v['id']): ?>selected='selected'<?php endif; ?>><?php echo str_repeat('-',$v['level']*8); echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>	
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="cat_name" data-required="1" class="span6 m-wrap" value="<?php echo ($data["cat_name"]); ?>" />
											<input type="hidden" name="id" date-require="1" class="span6 m-wrap" value="<?php echo ($info["id"]); ?>"/>
										</div>
									</div>																
	...
	<script>
		function del_pics(pic,pid){
			var gid=$("#cid").val();
			$.ajax({
				url:"<?php echo U('cat_ajax_del_pic');?>",
