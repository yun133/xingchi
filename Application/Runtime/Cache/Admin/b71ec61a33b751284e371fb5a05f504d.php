								...
								<form action="" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">											
											...
											<?php if(is_array($typedata)): foreach($typedata as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["type_name"]); ?></option><?php endforeach; endif; ?>
											</select>
											<br>
											<br>
	...
	<script>
		...
		jQuery(document).ready(function() {   
			...
			$("#goods_type").change(function(){
				...
				$.getJSON("<?php echo U('Goods/get_attr_by_type');?>",{"type_id":t_id},function(data){
