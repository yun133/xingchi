							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" class="form-horizontal" method="post">								
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="attr_name" data-required="1" class="span6 m-wrap" value="<?php echo ($data["attr_name"]); ?>" />
											<input type="hidden" name="type_id" value="<?php echo ($data["type_id"]); ?>" />
											<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">属性类型<span class="required">*</span></label>
										<div class="controls">
											<select class="span6 m-wrap" name="attr_type" id="attr_type">
												<option value="">请选择类型</option>
												<option value="可选" <?php if('可选'==$data['attr_type']): ?>selected='selected'<?php endif; ?>>可选</option>
												<option value="唯一" <?php if('唯一'==$data['attr_type']): ?>selected='selected'<?php endif; ?>>唯一</option>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="attr_option_value" id="a_o_v" <?php if('唯一'==$data['attr_type']): ?>disabled="disabled"<?php endif; ?>><?php echo ($data["attr_option_value"]); ?></textarea>
										</div>
									</div>																
