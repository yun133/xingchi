							...
							<div class="portlet-body form">
								...
								<form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="user_name" data-required="1" class="span6 m-wrap" value="<?php echo ($info["user_name"]); ?>" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="password" data-required="1" class="span6 m-wrap" value="<?php echo ($info["password"]); ?>"/>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											...
											<img src="<?php echo ($info["user_logo"]); ?>" style="height: 60px;width: 80px;"/>
										</div>										
									</div>
									<div class="control-group">
