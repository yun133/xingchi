							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<a href="<?php echo U('Category/cat_add');?>">
										...
										添加分类 <i class="icon-plus"></i></button></a>
...
<table class="table table-striped table-hover table-bordered" >
									...
									<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="">
											...
											<td><a class="delete" href="javascript:;" data-id="<?php echo ($v["id"]); ?>"onclick="delcat(<?php echo ($v["id"]); ?>)" >Delete</a></td>
	...
	<script type="text/javascript">
		function delcat(id) {
			if (confirm('您确定要删除这个分类吗?')) {				// alert(id);
