...
<ul>
<?php if(is_array($consignee)): foreach($consignee as $key=>$v): ?><li class="cur">
        <input type="radio" name="cgn_id" checked="checked" value="1" /><?php echo ($v["cgn_name"]); ?> <?php echo ($v["cgn_address"]); ?> <?php echo ($v["cgn_tel"]); ?>
        <a href="">设为默认地址</a>
        <a href="">编辑</a>
        <a href="">删除</a>
    </li><?php endforeach; endif; ?>
<!--     <li>
        <input type="radio" name="cgn_id" value="2" />王小二 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
        <a href="">设为默认地址</a>
        <a href="">编辑</a>
        <a href="">删除</a>
    </li> -->
