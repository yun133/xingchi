							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_1" class="form-horizontal" method="post">								
									...
									<div class="control-group">
										<label class="control-label">类型名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="type_name" data-required="1" class="span6 m-wrap" value="<?php echo ($data["type_name"]); ?>" />
											<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
										</div>
									</div>																
									<div class="form-actions">
										<button type="submit" class="btn purple">修改类型</button>
									</div>
								</form>
								<!-- END FORM-->
							</div>
