							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<a href="<?php echo U('Admin/admin_add');?>">
										...
										添加管理员 <i class="icon-plus"></i></button></a>
...
<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<?php if(is_array($lst)): foreach($lst as $key=>$v): ?><tr class="">
											...
											<td><?php echo ((isset($v["rols"]) && ($v["rols"] !== ""))?($v["rols"]):'暂未选取'); ?></td>
											<td><img src="<?php echo ($v["user_logo"]); ?>" title="没有图片" style="height: 45px;width: 60px;"></td>
											<td><a class="" href="<?php echo U('admin_edit',array('id'=>$v['id']));?>">Edit</a></td>
	...
	<script>
		c_url="<?php echo U('Admin/admin_del','',false);?>"
