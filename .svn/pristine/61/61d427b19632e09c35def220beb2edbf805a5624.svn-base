...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide1.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide2.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide3.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide4.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide5.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>index_slide6.jpg" alt="" /></a></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>ad.jpg" alt="" /></a></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>holiday.jpg" alt="" /></a>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>scenic.jpg" alt="" /></a>
                ...
                <div class="lottery none">
                    <p><img src="<?php echo C('HOME_IMAGE_PATH');?>lottery.jpg" alt="" /></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>sanguo.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>taohua.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>wulin.jpg" alt="" /></a></li>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
...
<div class="guide w1210 bc mt15">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>crazy1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>crazy2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>crazy3.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>crazy5.jpg" alt="" /></a></dt>
            ...
            <div class="hot none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>hot2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>hot3.jpg" alt="" /></a></dt>
            ...
            <div class="recommend none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>recommend1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>recommend2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>recommend3.jpg" alt="" /></a></dt>
            ...
            <div class="new none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>new1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>new2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>new3.jpg" alt="" /></a></dt>
            ...
            <div class="guess none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>guess1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>guess2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>guess3.jpg" alt="" /></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="sidebar_wrap">
            <dl class="first">
                <dt class="fl"><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>viewsonic.jpg" alt="" /></a></dt>
            ...
            <dl>
                <dt class="fr"><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>samsung.jpg" alt="" /></a></dt>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>notebook.jpg" alt="" /></a></p>
            </div>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>thinkpad e420.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>acer4739.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>samsung6800.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>lh531.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>qinghuax2.jpg" alt="" /></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>dell.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>acer.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>fujitsu.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>hp.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>lenove.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>samsung.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>dlink.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>seagate.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>intel.jpg" alt="" /></a></li>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
        ...
        <!-- 广告 start -->
        <div class="ads mt10">
            <a href=""><img src="<?php echo C('HOME_IMAGE_PATH');?>canon.jpg" alt="" /></a>
        </div>
        <!-- 广告 end -->
    </div>
    <!-- 右侧 end -->
