						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
									<a href="<?php echo U('Attribute/attr_add',array('type_id'=>I('get.type_id')));?>">
										<button class="btn green">
										添加属性 <i class="icon-plus"></i></button></a>
...
<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="">
											...
											<td><a class="" href="<?php echo U('attr_edit',array('id'=>$v['id'],'type_id'=>I('get.type_id')));?>">Edit</a></td>					
	...
	c_url="<?php echo U('Attribute/attr_del','',false);?>"
	</script>
</body>
<!-- END BODY -->
</html>